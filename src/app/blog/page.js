...
export const metadata = {
  ...
  description:
    "آخرین مقالات و راهنماهای طراحی داخلی، دکوراسیون منزل و استفاده از هوش مصنوعی",
};
      ...
      <div className="bg-gradient-to-r from-green-700 to-green-800 py-20">
        <div className="container mx-auto px-[50px]">
          ...
          <p className="text-xl text-gray-200">
            مقالات، راهنماها و نکات طراحی داخلی
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-[50px] py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post) => (
            ...
            >
              <article
                className=" bg-neutral-600 rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 h-full border border-neutral-800 hover:border-green-700 
"
              >
                {/* تصویر */}
