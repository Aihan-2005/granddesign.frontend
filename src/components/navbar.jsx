...
>>>>>>> 43e184b8d6c125a71fa514eeb522b6450374695a
        ...
        <Link
          href={"/store"}
          className="bg-[green] cursor-pointer text-white px-6 py-3 rounded-md text-base font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5"
        >
          فروشگاه
        </Link>
        {items.map((item) => (
...
<<<<<<< HEAD
      ...
      <div
        className={`fixed top-0 right-0 w-64 bg-gray-500 text-black shadow-lg transform transition-transform duration-300 z-50 h-screen p-4 overflow-y-auto -translate-x-full dark:bg-[#4e4e4e] ${
          isOpen ? "translate-x-0" : "translate-x-full"
        }`}
        tabIndex={-1}
        aria-labelledby="drawer-navigation-lable"
      >
        ...
        <button
          ...
          className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 absolute top-2.5 end-2.5 inline-flex items-center justify-center dark:hover:bg-[#959595] dark:hover:text-black"
        >
          <svg
            className="w-3 h-3"
            aria-hidden="true"
        ...
        <div className="py-4 overflow-y-auto">
          <ul className="font-medium space-y-2">
            <li>
              <button
                type="button"
                className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-[#959595]"
