    ...
    <div className="w-full  text-white my-8" dir="rtl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex cursor-pointer items-center justify-between bg-[#35357874] rounded-2xl p-6 mx-4 my-3 hover:bg-[#454588] hover:shadow-lg transition-all duration-300"
          >
               <Image
