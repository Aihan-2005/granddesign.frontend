            ...
            <div className="flex items-center justify-center min-h-screen pt-16">
                <div className="w-full max-w-sm p-4 bg-[#69b190] border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8 ">
                    <form className="space-y-6" action="#">
                        ...
                        <button 
                            type="submit" 
                            className="w-full text-white bg-[#217d55]  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                        >
                            پیگیری سفارش
                        </button>
